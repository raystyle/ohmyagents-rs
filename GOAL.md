...
- 当前目标：各功能部件 POC 验证原型。check、yolo、doctor、Windows pane 最小集（endpoint/session/layout/drive/dialogs/paste/locate）已完成；stream/state/init/negatives 未开；Linux/mac pane 跑测委托后续仓库。
