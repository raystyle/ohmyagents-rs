...
- **日期**：2026-09-08。
- **起点**：D16 立项。ohmycloud 对账五点（oma 无镜像开关）引出，用户裁「要做」：`oma self update` 加 OMA_MIRROR 镜像通道，让无 GitHub 直连环境（含 D13 的 mac）能吃 env.ohmygh.com 镜像。

## 锚点

> 当前锚定的目标 + 推进时间线。

- **锚定的目标**：D16 oma self update 镜像通道（PRD D16 已采纳，四点设计已裁）。
