...
| 落地方法一：库搜索分析法 | 已完成 | `docs\research\rust库搜索研发分析法-CLI与API选型实证.md`：CLI 与 API 本机实证（含镜像 `--registry crates-io` 订正）；第三方 CLI 四者实测留 cratesinfo 卸其余 | 2026-08-31 |
| 落地方法二：GitHub 研究法 | 已完成 | `docs\research\github搜索研究法-gh命令与仓库深读实证.md`：repos 搜索、质量信号、releases、clone 两档、文档搜索实证；两法齐升规则 | 2026-08-31 |
| 双通道选型规则 | 已完成 | `docs\guide\选型研究细则-cratesio与github双通道.md`；AGENTS 写 Rust 规则挂引用 | 2026-08-31 |
