...
| 落地方法一：库搜索分析法 | 已完成 | `docs\research\rust库搜索研发分析法-CLI与API选型实证.md`：CLI 与 API 本机实证（含镜像 `--registry crates-io` 订正）；第三方 CLI 四者实测留 cratesinfo 卸其余；待方法二到齐后升规则 | 2026-08-31 |
