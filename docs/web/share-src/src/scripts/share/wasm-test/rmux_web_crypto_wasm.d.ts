...
export class ServerSession {
     ...
     */
    static mlKemEncapsulate(encapsulation_key: Uint8Array, randomness: Uint8Array): Uint8Array;
    /**
...
export interface InitOutput {
    ...
    readonly serversession_mlKemEncapsulate: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    readonly serversession_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => [number, number, number];
